...
```powershell
# Activate the local venv (Windows)
...
python main.py --no-rent --apartments --no-houses --voivodeship mazowieckie --city warszawa --max-price 800000
python main.py --voivodeship malopolska --city krakow --district stare-miasto
